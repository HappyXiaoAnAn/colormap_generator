...
`,Fs="";function bc(e){Fs=e}function Og(e=""){if(!Fs){const t=[...document.getElementsByTagName("script")],n=t.find(r=>r.hasAttribute("data-shoelace"));if(n)bc(n.getAttribute("data-shoelace"));else{const r=t.find(i=>/shoelace(\.min)?\.js($|\?)/.test(i.src)||/shoelace-autoloader(\.min)?\.js($|\?)/.test(i.src));let o="";r&&(o=r.getAttribute("src")),bc(o.split("/").slice(0,-1).join("/"))}}return Fs.replace(/\/$/,"")+(e?`/${e.replace(/^\//,"")}`:"")}var Dg={name:"default",resolver:e=>Og(`assets/icons/${e}.svg`)},Ig=Dg,_c={caret:`
  ...
  `},Fg={name:"system",resolver:e=>e in _c?`data:image/svg+xml,${encodeURIComponent(_c[e])}`:""},Vg=Fg,jg=[Ig,Vg],Vs=[];function Bg(e){Vs.push(e)}function Ug(e){Vs=Vs.filter(t=>t!==e)}function kc(e){return jg.find(t=>t.name===e)}function gt(e,t){const n=An({waitUntilFirstUpdate:!1},t);return(r,o)=>{const{update:i}=r,l=Array.isArray(e)?e:[e];r.update=function(s){l.forEach(a=>{const u=a;if(s.has(u)){const h=s.get(u),f=this[u];h!==f&&(!n.waitUntilFirstUpdate||this.hasUpdated)&&this[o](h,f)}}),i.call(this,s)}}}/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Hg=(e,t)=>t===void 0?(e==null?void 0:e._$litType$)!==void 0:(e==null?void 0:e._$litType$)===t,Wg=e=>e.strings===void 0,Qg={},Kg=(e,t=Qg)=>e._$AH=t;var Er=Symbol(),Vo=Symbol(),Rl,Ol=new Map,at=class extends je{constructor(){super(...arguments),this.initialRender=!1,this.svg=null,this.label="",this.library="default"}async resolveIcon(e,t){var n;let r;if(t!=null&&t.spriteSheet)return Z`<svg part="svg">
        <use part="use" href="${e}"></use>
      </svg>`;try{if(r=await fetch(e,{mode:"cors"}),!r.ok)return r.status===410?Er:Vo}catch{return Vo}try{const o=document.createElement("div");o.innerHTML=await r.text();const i=o.firstElementChild;if(((n=i==null?void 0:i.tagName)==null?void 0:n.toLowerCase())!=="svg")return Er;Rl||(Rl=new DOMParser);const s=Rl.parseFromString(i.outerHTML,"text/html").body.querySelector("svg");return s?(s.part.add("svg"),document.adoptNode(s)):Er}catch{return Er}}connectedCallback(){super.connectedCallback(),Bg(this)}firstUpdated(){this.initialRender=!0,this.setIcon()}disconnectedCallback(){super.disconnectedCallback(),Ug(this)}getUrl(){const e=kc(this.library);return this.name&&e?e.resolver(this.name):this.src}handleLabelChange(){typeof this.label=="string"&&this.label.length>0?(this.setAttribute("role","img"),this.setAttribute("aria-label",this.label),this.removeAttribute("aria-hidden")):(this.removeAttribute("role"),this.removeAttribute("aria-label"),this.setAttribute("aria-hidden","true"))}async setIcon(){var e;const t=kc(this.library),n=this.getUrl();if(!n){this.svg=null;return}let r=Ol.get(n);if(r||(r=this.resolveIcon(n,t),Ol.set(n,r)),!this.initialRender)return;const o=await r;if(o===Vo&&Ol.delete(n),n===this.getUrl()){if(Hg(o)){this.svg=o;return}switch(o){case Vo:case Er:this.svg=null,this.emit("sl-error");break;default:this.svg=o.cloneNode(!0),(e=t==null?void 0:t.mutator)==null||e.call(t,this.svg),this.emit("sl-load")}}}render(){return this.svg}};at.styles=Rg;v([Fe()],at.prototype,"svg",2);v([_({reflect:!0})],at.prototype,"name",2);v([_()],at.prototype,"src",2);v([_()],at.prototype,"label",2);v([_({reflect:!0})],at.prototype,"library",2);v([gt("label")],at.prototype,"handleLabelChange",1);v([gt(["name","src","library"])],at.prototype,"setIcon",1);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Rt={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},Ba=e=>(...t)=>({_$litDirective$:e,values:t});let Ua=class{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,n,r){this._$Ct=t,this._$AM=n,this._$Ci=r}_$AS(t,n){return this.update(t,n)}update(t,n){return this.render(...n)}};/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const kt=Ba(class extends Ua{constructor(e){var t;if(super(e),e.type!==Rt.ATTRIBUTE||e.name!=="class"||((t=e.strings)===null||t===void 0?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter(t=>e[t]).join(" ")+" "}update(e,[t]){var n,r;if(this.it===void 0){this.it=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter(i=>i!=="")));for(const i in t)t[i]&&!(!((n=this.nt)===null||n===void 0)&&n.has(i))&&this.it.add(i);return this.render(t)}const o=e.element.classList;this.it.forEach(i=>{i in t||(o.remove(i),this.it.delete(i))});for(const i in t){const l=!!t[i];l===this.it.has(i)||!((r=this.nt)===null||r===void 0)&&r.has(i)||(l?(o.add(i),this.it.add(i)):(o.remove(i),this.it.delete(i)))}return Ke}});/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const j=e=>e??ee;/**
...
`,Ap=class extends je{constructor(){super(...arguments),this.localize=new mo(this)}render(){return Z`
...
`,t+="# cmap = manual_cmap()",t}Bl.createRoot(document.getElementById("root")).render(D.jsx(qc.StrictMode,{children:D.jsx(uv,{})}));
